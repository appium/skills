...
- For real iOS or tvOS devices, complete
  `skills/setup-xcuitest/SKILL.md` and follow its continuation to
  `skills/xcuitest-real-device-config/SKILL.md` before recommending signing,
  provisioning, or WebDriverAgent deployment capabilities.

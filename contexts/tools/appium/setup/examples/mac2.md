---
owner: appium
policy_scope: "contexts/tools/appium/setup/examples/mac2.md"
id: appium.setup.examples.mac2
network_allowed: true
external_upload_allowed: false
secrets_allowed: false
allowed_data:
  - contexts/tools/appium/setup/examples/mac2.md local workflow inputs, public URLs, and sanitized diagnostics
  - contexts/tools/appium/setup/examples/mac2.md bounded command output, local paths, driver names, IDs, and logs

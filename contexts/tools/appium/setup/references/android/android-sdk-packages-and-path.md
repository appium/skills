---
owner: appium
policy_scope: "contexts/tools/appium/setup/references/android/android-sdk-packages-and-path.md"
...
allowed_data:
  - contexts/tools/appium/setup/references/android/android-sdk-packages-and-path.md local workflow inputs, public URLs, and sanitized diagnostics
  - contexts/tools/appium/setup/references/android/android-sdk-packages-and-path.md bounded command output, local paths, driver names, IDs, and logs

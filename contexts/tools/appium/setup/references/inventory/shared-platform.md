...
Declared-reference group for shared setup assets, command-mode profiles, and host profiles. Use `contexts/tools/appium/setup/references/support-inventory.md` for the grouped setup index.

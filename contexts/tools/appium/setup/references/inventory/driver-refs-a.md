...
# Driver References Inventory A

Declared-reference group for Chromium, Espresso, and Gecko setup references. Use `contexts/tools/appium/setup/references/support-inventory.md` for the grouped setup index.

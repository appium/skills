---
owner: appium
id: appium-setup-inventory-driver-refs-b
status: stable
...
# Driver References Inventory B

Declared-reference group for Mac2, Safari, and UiAutomator2 setup references. Use `contexts/tools/appium/setup/references/support-inventory.md` for the grouped setup index.

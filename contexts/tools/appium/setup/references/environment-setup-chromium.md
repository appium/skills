---
owner: appium
policy_scope: "contexts/tools/appium/setup/references/environment-setup-chromium.md"
...
allowed_data:
  - contexts/tools/appium/setup/references/environment-setup-chromium.md local workflow inputs, public URLs, and sanitized diagnostics
  - contexts/tools/appium/setup/references/environment-setup-chromium.md bounded command output, local paths, driver names, IDs, and logs

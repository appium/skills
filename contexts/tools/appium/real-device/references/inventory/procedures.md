...
owner: appium
id: xcuitest-real-device-inventory-procedures
status: stable
optional_context:
...
# XCUITest Real Device Procedure Inventory

Declared-reference group for ordered real-device XCUITest procedure parts.

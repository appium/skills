---
owner: appium
policy_scope: "contexts/tools/appium/real-device/examples/real-device.md"
id: appium.real-device.examples.real-device
network_allowed: true
external_upload_allowed: false
secrets_allowed: true
allowed_data:
  - contexts/tools/appium/real-device/examples/real-device.md local workflow inputs, public URLs, and sanitized diagnostics
  - contexts/tools/appium/real-device/examples/real-device.md bounded command output, local paths, driver names, IDs, and logs

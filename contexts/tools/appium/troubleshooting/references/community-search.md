---
owner: appium
policy_scope: "contexts/tools/appium/troubleshooting/references/community-search.md"
id: appium.troubleshooting.references.community-search
network_allowed: true
external_upload_allowed: false
secrets_allowed: false
allowed_data:
  - contexts/tools/appium/troubleshooting/references/community-search.md local workflow inputs, public URLs, and sanitized diagnostics
  - contexts/tools/appium/troubleshooting/references/community-search.md bounded command output, local paths, driver names, IDs, and logs

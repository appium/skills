---
owner: appium
policy_scope: "contexts/tools/appium/troubleshooting/procedure-part1.md"
...
allowed_data:
  - contexts/tools/appium/troubleshooting/procedure-part1.md local workflow inputs, public URLs, and sanitized diagnostics
  - contexts/tools/appium/troubleshooting/procedure-part1.md bounded command output, local paths, driver names, IDs, and logs
